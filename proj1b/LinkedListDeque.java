...
public class LinkedListDeque<Item> implements Deque<Item> {
    ...
    /** Node in the linked list that could hold any Item of data. */
    public class Node {
        public Item item;
        public Node next;
        public Node prev;
        ...
        public Node (Item first, Node prev_item, Node next_item) {
            item = first;
            prev = prev_item;
            next = next_item;
        }
    ...
    public LinkedListDeque(LinkedListDeque other) {
        ...
        for (int i = 0; i < otherLength; i += 1) {
            Item new_item = (Item) other.get(i);
     ...
     */
    public LinkedListDeque(Item first) {
